          ...
          <div className="mx-auto lg:col-10">
            ...
            >
              <div className="mb-6 md:grid grid-cols-2 gap-x-8 max-md:space-y-6">
                <div>
                  <label htmlFor="name" className="form-label text-text-dark dark:text-darkmode-text-dark">
              ...
              <div className="mb-6 md:grid grid-cols-2 gap-x-8 max-md:space-y-6">
                <div>
                  <label htmlFor="email" className="form-label text-text-dark dark:text-darkmode-text-dark">
              ...
              <div className="mb-6">
                <label htmlFor="message" className="form-label text-text-dark dark:text-darkmode-text-dark">
